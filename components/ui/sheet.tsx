...
// SheetOverlay Component with TypeScript types
...
// Variants for Sheet content positioning
...
// SheetContent Component with TypeScript types
...
// SheetHeader Component with TypeScript types
const SheetHeader = ({ className, ...props }: React.HTMLProps<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-2 text-center sm:text-left", className)} {...props} />
);
SheetHeader.displayName = "SheetHeader";

// SheetFooter Component with TypeScript types
const SheetFooter = ({ className, ...props }: React.HTMLProps<HTMLDivElement>) => (
  <div className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className)} {...props} />
);
SheetFooter.displayName = "SheetFooter";

// SheetTitle Component with TypeScript types
...
// SheetDescription Component with TypeScript types
